          ...
          },
          {
            ...
            depedants: [
              ...
              },
              {
                ...
                type: 'autoFill',
                pattern: '/inventory-services/pricelists/_gettenderusedquantity?tenantId=default&material={purchaseOrders[0].purchaseOrderDetails[0].material.code}&priceListId={purchaseOrders[0].purchaseOrderDetails[0].priceList.id}&uom={purchaseOrders[0].purchaseOrderDetails[0].uom.code}|$..quantity|$..quantity',
                autoFillFields: {
              ...
              },
              {
                ...
                type: 'autoFill',
                pattern: '/inventory-services/fifologic/_stock?tenantId=default&supplierName={purchaseOrders[0].supplier.code}&rateType={purchaseOrders[0].rateType}&active=true&asOnDate={purchaseOrders[0].purchaseOrderDate}&materialCode={purchaseOrders[0].purchaseOrderDetails[0].material.code}&rateContractNumber={purchaseOrders[0].purchaseOrderDetails[0].priceList.rateContractNumber}&uom={purchaseOrders[0].purchaseOrderDetails[0].uom.code}|$..quantity|$..quantity',
                autoFillFields: {
                  'purchaseOrders[0].purchaseOrderDetails[0].balanceQuantity': 'priceLists[0].priceListDetails[0].quantity',
                },
              },
              {
                jsonPath: 'purchaseOrders[0].purchaseOrderDetails[0].unitPrice',
                type: 'autoFill',
                pattern: '/inventory-services/fifologic/_unitrate?tenantId=default&supplierName={purchaseOrders[0].supplier.code}&rateType={purchaseOrders[0].rateType}&active=true&asOnDate={purchaseOrders[0].purchaseOrderDate}&materialCode={purchaseOrders[0].purchaseOrderDetails[0].material.code}&rateContractNumber={purchaseOrders[0].purchaseOrderDetails[0].priceList.rateContractNumber}&uom={purchaseOrders[0].purchaseOrderDetails[0].uom.code}|$..quantity|$..quantity',
                autoFillFields: {
