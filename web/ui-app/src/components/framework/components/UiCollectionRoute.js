...
class UiCollectionRoute extends Component {
  ...
  fetchCollectionPoint = levelName => {
    ...
    Api.commonApiPost('/swm-services/collectionpoints/_search?', queryObj, {}, false, true).then(res => {
      var jpath = '';
      // console.log(res);
      this.setState({
  ...
  render() {
    return (
      <div>
        <Boundary callbackFromCollectionRoute={this.boundaryDropDownDataVal} item={this.props.item} ui={this.props.ui} screen={this.props.screen} />
