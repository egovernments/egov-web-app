...
const pgrTransfomer = data => {
  ...
  complaintsReopened = complaintsReopened === 'yes' ? true : complaintsReopened === 'false' ? false : complaintsReopened;
...
const pgrReverseTransformer = data => {
  const fieldJsonPath = 'complaints.reopened';
  let complaintsReopened = _.get(data, fieldJsonPath);
  complaintsReopened = complaintsReopened == true ? 'yes' : complaintsReopened == false ? 'no' : complaintsReopened;
  _.set(data, fieldJsonPath, complaintsReopened);
};
