...
const AdditionalDetails = ({ importantDates }) => {
  const taxHeadEstimates = JSON.parse('[{"taxHeadCode":"PT_TAX","estimateAmount":2222,"category":"TAX"},{"taxHeadCode":"PT_UNIT_USAGE_EXEMPTION","estimateAmount":0,"category":"EXEMPTION"},{"taxHeadCode":"PT_FIRE_CESS","estimateAmount":600,"category":"TAX"},{"taxHeadCode":"PT_OWNER_EXEMPTION","estimateAmount":0,"category":"EXEMPTION"},{"taxHeadCode":"PT_TIME_REBATE","estimateAmount":366.86,"category":"EXEMPTION"},{"taxHeadCode":"PT_TIME_PENALTY","estimateAmount":0,"category":"EXEMPTION"},{"taxHeadCode":"PT_TIME_INTEREST","estimateAmount":0,"category":"PENALTY"}]')
      ...
      <CardHeader
        ...
        title={
          <div className="tax-header">
            <Label label="Property Tax Dues:" className="tax-due-header" />
