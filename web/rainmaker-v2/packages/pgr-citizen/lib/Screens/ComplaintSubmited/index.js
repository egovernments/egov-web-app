...
var ComplaintSubmitted = function (_Component) {
  ...
  function ComplaintSubmitted() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = ComplaintSubmitted.__proto__ || Object.getPrototypeOf(ComplaintSubmitted)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidMount = function () {
      var resetFiles = _this.props.resetFiles;

      if (_this.props.form && _this.props.form.complaint) {
        resetFiles("complaint");
      }
    }, _this.continueComplaintSubmit = function () {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "div",
            { className: "btn-without-bottom-nav col-lg-offset-3 col-md-offset-3 col-lg-6 col-md-6" },
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ComplaintSubmitted);