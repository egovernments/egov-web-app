...
var _ReceiptDialog = require("./components/ReceiptDialog");
  ...
  (0, _createClass3.default)(Property, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        _common.Screen,
        null,
        _react2.default.createElement(_components.BreadCrumbs, { url: urls.length > 0 ? urls : urlArray, pathname: pathname, history: history }),
        ...
        _react2.default.createElement(_ReceiptDialog2.default, { open: this.state.dialogueOpen, closeDialogue: this.closeReceiptDialogue })
      );
    }
  }]);
  return Property;
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getAssessmentListItems = function (props) {
    ...
    return [{
      ...
      nestedItems: [{
        secondaryText: _react2.default.createElement(_PropertyInformation2.default, { items: propertyItems, propertyTaxAssessmentID: propertyId })
      }],
      ...
      nestedItems: [{
        primaryText: _react2.default.createElement(_translationNode2.default, { label: "2018 - 2019", fontSize: "16px", color: "#484848", containerStyle: { padding: "10px 0" } }),
        status: "Paid",
        receipt: true
      }, {
        primaryText: _react2.default.createElement(_translationNode2.default, { label: "2017 - 2018", fontSize: "16px", color: "#484848", containerStyle: { padding: "10px 0" } }),
        status: "ASSESS & PAY",
        receipt: true
      }, {
        primaryText: _react2.default.createElement(_translationNode2.default, { label: "2016 - 2017", fontSize: "16px", color: "#484848", containerStyle: { padding: "10px 0" } }),
        status: "Paid",
        receipt: true
      }, {
        primaryText: _react2.default.createElement(_translationNode2.default, { label: "2015 - 2016", fontSize: "16px", color: "#484848", containerStyle: { padding: "10px 0" } }),
        status: "ASSESS & PAY",
        receipt: true
      }, {
        primaryText: _react2.default.createElement(_translationNode2.default, { label: "2014 - 2015", fontSize: "16px", color: "#484848", containerStyle: { padding: "10px 0" } }),
        status: "ASSESS & PAY",
        receipt: true
      }, {
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  return { urls: urls, propertyItems: propertyItems, propertyId: propertyId, customTitle: customTitle };
};
