          ...
          case 19:
            ...
            try {
              data = response.map(function (item) {
                ...
                return _ref2 = {}, (0, _defineProperty3.default)(_ref2, (0, _get2.default)(_searchResult.textToLocalMapping, "Receipt No."), item.receiptNumber || "-"), (0, _defineProperty3.default)(_ref2, (0, _get2.default)(_searchResult.textToLocalMapping, "Payee Name"), item.payeeName || "-"), (0, _defineProperty3.default)(_ref2, (0, _get2.default)(_searchResult.textToLocalMapping, "Service Type"), item.serviceType || "-"), (0, _defineProperty3.default)(_ref2, (0, _get2.default)(_searchResult.textToLocalMapping, "Date"), (0, _index.convertEpochToDate)(item.date) || "-"), (0, _defineProperty3.default)(_ref2, (0, _get2.default)(_searchResult.textToLocalMapping, "Amount[INR]"), item.amount || "-"), (0, _defineProperty3.default)(_ref2, (0, _get2.default)(_searchResult.textToLocalMapping, "Status"), item.status || "-"), (0, _defineProperty3.default)(_ref2, "tenantId", item.tenantId), _ref2;
              });

              dispatch((0, _actions.handleScreenConfigurationFieldChange)("search", "components.div.children.searchResult", "props.data", data));
              dispatch((0, _actions.handleScreenConfigurationFieldChange)("search", "components.div.children.searchResult", "props.title", "Search Results for Receipt (" + data.length + ")"));
