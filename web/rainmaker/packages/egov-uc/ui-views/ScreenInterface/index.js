...
var ScreenInterface = function (_React$Component) {
  ...
  (0, _createClass3.default)(ScreenInterface, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var currentMatch = this.props.match;
      var nextParams = nextMatch.params;
      var currentParams = currentMatch.params;
      var nextPath = nextParams.path,
          nextScreenKey = nextParams.screenKey;
      var currentPath = currentParams.path,
          currentScreenKey = currentParams.screenKey;
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.initInterface = function (props) {
    ...
    if (path && screenKey) {
      _this2.setState({
        view: (0, _uiHocs.screenHoc)({ path: path, screenKey: screenKey, hasRemoteConfig: hasRemoteConfig })(_CommonView2.default)
      });
    }
  };
};
