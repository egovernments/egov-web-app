...
var _index = require("../../ui-config/screens/specs/utils/index");
...
var getLocaleLabelsforTL = function getLocaleLabelsforTL(label, labelKey, localizationLabels) {
  if (labelKey) {
    var translatedLabel = (0, _index.getTranslatedLabel)(labelKey, localizationLabels);
...
var LabelContainer = function (_React$Component) {
  ...
  (0, _createClass3.default)(LabelContainer, [{
    ...
    value: function render() {
      ...
      var transfomedKeys = (0, _index.transformById)(localizationLabels, "code");
