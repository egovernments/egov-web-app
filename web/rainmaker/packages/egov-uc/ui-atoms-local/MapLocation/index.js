...
var _nocAppConfig = require("../../ui-config/noc-app-config");
...
var MapLocation = compose(withProps({
  googleMapURL: "https://maps.googleapis.com/maps/api/js?key=" + _nocAppConfig.MAP_API_KEY + "&v=3.exp&libraries=geometry,drawing,places",
