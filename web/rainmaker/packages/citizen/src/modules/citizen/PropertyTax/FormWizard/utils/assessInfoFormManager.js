...
const combinationToFormkeyMapping = {
  "RESIDENTIAL-INDEPENDENTPROPERTY": {
    ...
    plotForm: formHoc({ formKey: "plotDetails",isCoreConfiguration:true, path: "PropertyTaxPay/ResidentialIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
    floorForm: formHoc({ formKey: "floorDetails", makeCopy: true, path: "PropertyTaxPay/ResidentialIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
  ...
  "RESIDENTIAL-SHAREDPROPERTY": {
    ...
    plotForm: formHoc({ formKey: "plotDetails",isCoreConfiguration:true, path: "PropertyTaxPay/ResidentialSharedProperty" ,isCoreConfiguration:true})(GenericForm),
    floorObject: { formKey: "floorDetails",isCoreConfiguration:true, makeCopy: true, copyName: "floorDetails", path: "PropertyTaxPay/ResidentialIndependantProperty" },
    hasPlot: true,
    hasFloor: false,
  },
  "MIXED-INDEPENDENTPROPERTY": {
    ...
    plotForm: formHoc({ formKey: "plotDetails",isCoreConfiguration:true, path: "PropertyTaxPay/MixedIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
    floorForm: formHoc({ formKey: "floorDetails", makeCopy: true, path: "PropertyTaxPay/MixedIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
  ...
  "COMMERCIAL-INDEPENDENTPROPERTY": {
    ...
    plotForm: formHoc({ formKey: "plotDetails",isCoreConfiguration:true, path: "PropertyTaxPay/CommercialIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
    floorForm: formHoc({ formKey: "floorDetails", makeCopy: true, path: "PropertyTaxPay/CommercialIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
  ...
  "INDUSTRIAL-INDEPENDENTPROPERTY": {
    ...
    plotForm: formHoc({ formKey: "plotDetails",isCoreConfiguration:true, path: "PropertyTaxPay/IndustrialIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
    floorForm: formHoc({ formKey: "floorDetails", makeCopy: true, path: "PropertyTaxPay/IndustrialIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
  ...
  "RELIGIOUS-INDEPENDENTPROPERTY": {
    ...
    plotForm: formHoc({ formKey: "plotDetails",isCoreConfiguration:true, path: "PropertyTaxPay/ReligiousIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
    floorForm: formHoc({ formKey: "floorDetails", makeCopy: true, path: "PropertyTaxPay/ReligiousIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
  ...
  "INSTITUTIONAL-INDEPENDENTPROPERTY": {
    ...
    plotForm: formHoc({ formKey: "plotDetails",isCoreConfiguration:true, path: "PropertyTaxPay/InstitutionalIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
    floorForm: formHoc({ formKey: "floorDetails", makeCopy: true, path: "PropertyTaxPay/InstitutionalIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
  ...
  "OTHERS-INDEPENDENTPROPERTY": {
    ...
    plotForm: formHoc({ formKey: "plotDetails",isCoreConfiguration:true, path: "PropertyTaxPay/OtherIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
    floorForm: formHoc({ formKey: "floorDetails", makeCopy: true, path: "PropertyTaxPay/OtherIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
  ...
  "PUBLICSPACES-INDEPENDENTPROPERTY": {
    ...
    plotForm: formHoc({ formKey: "plotDetails",isCoreConfiguration:true, path: "PropertyTaxPay/PublicSpaceIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
    floorForm: formHoc({ formKey: "floorDetails", makeCopy: true, path: "PropertyTaxPay/PublicSpaceIndependantProperty" ,isCoreConfiguration:true})(GenericForm),
  ...
  "COMMON-VACANT": {
    ...
    plotForm: formHoc({ formKey: "plotDetails",isCoreConfiguration:true, path: "PropertyTaxPay/CommonVacantLandProperty" ,isCoreConfiguration:true})(GenericForm),
    hasPlot: true,
    hasFloor: false,
  },
};
