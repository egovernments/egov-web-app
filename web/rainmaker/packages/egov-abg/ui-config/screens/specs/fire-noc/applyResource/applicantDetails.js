  ...
  applicantTypeContainer: (0, _utils.getCommonContainer)({
    applicantType: (0, _extends3.default)({}, (0, _utils.getSelectField)({
      ...
      afterFieldChange: function afterFieldChange(action, state, dispatch) {
        ...
        var applicantSubtypeJsonPath = "components.div.children.formwizardThirdStep.children.applicantDetails.children.cardContent.children.applicantTypeContainer.children.applicantSubType";
