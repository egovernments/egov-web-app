      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            isSearchBoxFirstRowValid = (0, _utils.validateFields)("components.div.children.fireNOCApplication.children.cardContent.children.searchContainer.children", state, dispatch, "search");
            ...
            if (!(isSearchBoxFirstRowValid && isSearchBoxSecondRowValid)) {
              ...
              try {
                data = response.map(function (item) {
                  ...
                  return _ref2 = {}, (0, _defineProperty3.default)(_ref2, (0, _get2.default)(_searchResults.textToLocalMapping, "Property ID"), item.propertyId || "-"), (0, _defineProperty3.default)(_ref2, (0, _get2.default)(_searchResults.textToLocalMapping, "Assessment No"), item.assessmentNumber || "-"), (0, _defineProperty3.default)(_ref2, (0, _get2.default)(_searchResults.textToLocalMapping, "Owner Name"), item.ownerName || "-"), (0, _defineProperty3.default)(_ref2, (0, _get2.default)(_searchResults.textToLocalMapping, "Date Created"), (0, _index.convertEpochToDate)(item.dateCreated) || "-"), (0, _defineProperty3.default)(_ref2, "tenantId", item.tenantId), _ref2;
                });
