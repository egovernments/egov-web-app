...
var sampleSearch = exports.sampleSearch = function sampleSearch() {
  var res = {
    ResponseInfo: {
      apiId: "Rainmaker",
      ver: ".01",
...
var sampleSingleSearch = exports.sampleSingleSearch = function sampleSingleSearch() {
  return {
    ResponseInfo: {
      apiId: "Mihy",
      ver: ".01",
...
var sampleDocUpload = exports.sampleDocUpload = function sampleDocUpload() {
  return {
    "0": {
      documentType: "OWNER",
...
var sampleGetBill = exports.sampleGetBill = function sampleGetBill() {
  return {
    ResposneInfo: null,
    Bill: [{
