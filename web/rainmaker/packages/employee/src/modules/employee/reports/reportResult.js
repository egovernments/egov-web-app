...
class ShowField extends Component {
  ...
  componentDidUpdate() {
    ...
    if (reportDetails && reportDetails.hasOwnProperty("additionalConfig")) {
      if (reportDetails.additionalConfig.hasOwnProperty("tableConfig")) {
        tableConfig = reportDetails.additionalConfig.tableConfig;
      }
      if (reportDetails && reportDetails.hasOwnProperty("additionalConfig") && reportDetails.additionalConfig.hasOwnProperty("reportTitle")) {
