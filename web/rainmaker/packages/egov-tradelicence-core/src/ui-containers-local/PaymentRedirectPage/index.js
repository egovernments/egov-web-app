  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      if (get(pgUpdateResponse, "Transaction[0].txnStatus") === "FAILURE") {
        ...
        window.location.href = `/employee-tradelicence/mihy-ui-framework/tradelicence/acknowledgement?purpose=${"pay"}&status=${"success"}&applicationNumber=${moduleId}&tenantId=${tenantId}&secondNumber=${transactionId}`;
      }
    } catch (e) {
      alert(e);
