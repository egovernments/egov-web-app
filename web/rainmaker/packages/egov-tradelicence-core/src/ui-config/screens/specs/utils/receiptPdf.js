...
import { transformedReceiptData } from "./receiptTransformer";
...
const getReceiptData = async () => {
  let transformedData = await transformedReceiptData();
  var receiptData = {
    content: [
      {
        style: "tl-head",
        ...
        table: {
          ...
          body: [
            ...
            [
              ...
              {
                text: `${transformedData.bankName}, ${transformedData.branchName}`,
                border: payableAmountBorderKey,
                style: "receipt-table-value"
              }
            ]
