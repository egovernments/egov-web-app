  ...
  (0, _createClass3.default)(DownloadFileContainer, [{
    ...
    value: function render() {
      var _props = this.props,
          data = _props.data,
          hardCodedData = _props.hardCodedData,
          rest = (0, _objectWithoutProperties3.default)(_props, ["data", "hardCodedData"]);

      return _react2.default.createElement(_uiMolecules.MultiDownloadCard, (0, _extends3.default)({ data: data ? data : hardCodedData }, rest));
    }
  }]);
