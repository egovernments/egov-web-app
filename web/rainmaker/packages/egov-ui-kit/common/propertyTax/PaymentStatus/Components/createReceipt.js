...
var getTaxInfo = function getTaxInfo(
  ...
  var taxArray = transformedHeaders.reduce(
    function(result, current) {
      result[0].push({
        text: (0, _commons.getTranslatedLabel)(current, localizationLabels)
      });
      ...
      var taxHeadContent = billAccountDetails.filter(function(item) {
        return (
          ...
          item.accountDescription.split("-")[0] === current
        );
      });
      taxHeadContent &&
        taxHeadContent[0] &&
        result[1].push({
          text:
            taxHeadContent[0] && taxHeadContent[0].crAmountToBePaid
              ? negativeHeaders.indexOf(
                  taxHeadContent[0].accountDescription.split("-")[0]
                ) > -1
...
var createReceiptDetails = function createReceiptDetails(
  property,
  propertyDetails,
  receiptDetails,
  localizationLabels,
  ...
  return {
    ...
    taxNew:
      receiptDetails &&
      getTaxInfo(
        receiptDetails.Bill[0].billDetails[0].billAccountDetails,
        receiptDetails.Bill[0].billDetails[0].totalAmount,
        localizationLabels
      ),
    tax: {
      AmountPaid: "100",
    ...
    receipts: {
      ...
      bankName:
        receiptDetails &&
        (0, _get2.default)(receiptDetails, "instrument.bank.id", "NA"),
      payMode:
        receiptDetails &&
        (0, _get2.default)(
          receiptDetails,
      ...
      transactionNo:
        receiptDetails &&
        (0, _get2.default)(receiptDetails, "instrument.transactionNumber"),
      transactionDate:
        receiptDetails &&
        (0, _commons.getDateFromEpoch)(
          (0, _get2.default)(receiptDetails, "instrument.transactionDateInput")
        ),
      bankNameBranch:
        receiptDetails &&
        (0, _get2.default)(receiptDetails, "instrument.bank.id") +
          ", " +
          (0, _get2.default)(receiptDetails, "instrument.branchName"),
      G8receiptNo:
        receiptDetails &&
        (0, _get2.default)(
          receiptDetails,
...
var createReceiptUIInfo = function createReceiptUIInfo(
  property,
  receiptDetails,
  cities,
  totalAmountToPay,
  ...
  return {
    propertyInfo:
      property &&
      [].concat((0, _toConsumableArray3.default)(ownerInfo), [
        {
        ...
        },
        {
          ...
          value: (0, _commons.getCommaSeperatedAddress)(
            property.address,
            cities
          )
        }
    ...
    receiptInfo: [
      {
        ...
        value:
          ...
          (0, _get2.default)(
            receiptDetails,
            success
              ? "Bill[0].billDetails[0].consumerCode"
              : "billDetails[0].consumerCode"
          ).split(":")[1]
      },
      {
        key: "Receipt No:",
