...
var Property = (function(_Component) {
  ...
  function Property(props) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(
      this,
      (Property.__proto__ || Object.getPrototypeOf(Property)).call(this, props)
    );
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.componentDidMount = function() {
    ...
    if (!(localStorage.getItem("path") === pathname)) {
      customTitle &&
        addBreadCrumbs({ title: customTitle, path: window.location.pathname });
    }
      ...
      primaryText: _react2.default.createElement(
        "div",
        {
          onClick: function onClick() {
            history.push(
              "/property-tax/my-properties/property/view-assessments/" +
                propertyId
            );
          }
        },
...
var getAssessmentInfo = function getAssessmentInfo(
  propertyDetails,
  keys,
  generalMDMSDataById
) {
...
var getLatestPropertyDetails = function getLatestPropertyDetails(
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  var latestPropertyDetails = getLatestPropertyDetails(
  ...
  var assessmentInfo = generalMDMSDataById
    ? getAssessmentInfo(
  ...
  var propertyItems = [].concat(
    (0, _toConsumableArray3.default)(addressInfo),
    (0, _toConsumableArray3.default)(assessmentInfo),
    (0, _toConsumableArray3.default)(ownerInfo)
  );
  var customTitle = (0, _commons.getCommaSeperatedAddress)(
    selPropertyDetails.address.buildingName,
    selPropertyDetails.address.street
  );

  var propertyDetails = selPropertyDetails.propertyDetails;

  var transformedAssessments = Object.values(propertyDetails).map(function(
    assessment,
    index
  ) {
    return {
      primaryText: _react2.default.createElement(_translationNode2.default, {
        label: assessment.financialYear,
        fontSize: "16px",
        color: "#484848",
  ...
  return {
    ...
    transformedAssessments: transformedAssessments
  };
};
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    ...
    fetchGeneralMDMSData: function fetchGeneralMDMSData(
      ...
      return dispatch(
        (0, _actions2.fetchGeneralMDMSData)(requestBody, moduleName, masterName)
      );
    }
  };
};
