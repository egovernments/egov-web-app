      ...
      items.map(function(item, index) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            item.showTable
              ? _react2.default.createElement(_AssessmentInfoTable2.default, {
                  items: item.items,
                  tableHeaderItems: item.tableHeaderItems
                })
              : item.nestedItems
                ? item.items.map(function(nestedItem, nestedIndex) {
                    return _react2.default.createElement(_Receipt2.default, {
                      receiptItems: nestedItem.items,
                      header:
                        item.items.length > 1 && "Owner " + (nestedIndex + 1)
                    });
                  })
                : _react2.default.createElement(_Receipt2.default, {
