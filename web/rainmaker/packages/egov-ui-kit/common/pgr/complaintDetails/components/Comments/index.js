...
var WriteCommentHOC = (0, _form2.default)({ formKey: "comment" })(
  _WriteComment2.default
);
...
var Comments = (function(_Component) {
  ...
  function Comments() {
    ...
    return (0, _possibleConstructorReturn3.default)(
      this,
      (Comments.__proto__ || Object.getPrototypeOf(Comments)).apply(
        this,
        arguments
      )
    );
  ...
  (0, _createClass3.default)(Comments, [
    {
      ...
      value: function render() {
        ...
        var items =
          ...
          transformedCommentList.map(function(comment, index) {
              ...
              return {
                leftAvatar: _react2.default.createElement(
                  ...
                  _react2.default.createElement(_components.Image, {
                    ...
                    size: "medium",
                    source: comment.avatar ? comment.avatar : _download2.default
                  })
                ),
                primaryText: _react2.default.createElement(
                  ...
                  _react2.default.createElement(_translationNode2.default, {
                    ...
                    fontSize: "10px",
                    label: (0, _commons.getDateFromEpoch)(comment.when)
                  })
                )
              };
            } else {
        ...
        var status =
          selectedComplaint &&
          selectedComplaint.actions.filter(function(action, index) {
            return action.status;
          });
        var currentstatus =
          status && status[0].status && status[0].status.toLowerCase();
        return _react2.default.createElement(
          "div",
          null,
          this.props.hasComments ||
          (currentstatus && currentstatus.toLowerCase() !== "closed")
            ? _react2.default.createElement(_components.Card, {
                ...
                textChildren: _react2.default.createElement(
                  ...
                  (isAssignedToEmployee && role === "employee") ||
                  role === "citizen" ||
                  role === "ao" ||
                  role === "csr"
                    ? currentstatus &&
                      currentstatus.toLowerCase() !== "closed" &&
                      _react2.default.createElement(WriteCommentHOC, {
                        userImage: userImage,
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  var transformedCommentList =
    commentList &&
    commentList.map(function(comment, commentIndex) {
      var role = comment.by.split(":")[1];
      var id = comment.by.split(":")[0];
      var assignments =
        role !== "Citizen" &&
        (0, _commons.getPropertyFromObj)(employeeById, id, "assignments", "");
      var designationCode =
        assignments && assignments[0] && assignments[0].designation;
      return {
        role: role,
        complainant: complainant,
        avatar:
          role === "Citizen"
            ? (0, _commons.getPropertyFromObj)(citizenById, id, "photo", "")
            : (0, _commons.getPropertyFromObj)(employeeById, id, "photo", ""),
        name:
          role === "Citizen"
            ? (0, _commons.getPropertyFromObj)(citizenById, id, "name", "")
            : (0, _commons.getPropertyFromObj)(employeeById, id, "name", ""),
        designation:
          role !== "Citizen"
            ? (0, _commons.getPropertyFromObj)(
                designationsById,
                designationCode,
                "name",
                ""
  ...
  var hasComments =
    transformedCommentList && transformedCommentList.length ? true : false;
  ...
  return {
    ...
    userId: userId,
    userName: userName,
    transformedCommentList: transformedCommentList,
