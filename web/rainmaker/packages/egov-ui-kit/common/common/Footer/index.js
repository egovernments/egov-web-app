...
var Footer = function (_Component) {
  ...
  (0, _createClass3.default)(Footer, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_components.BottomNavigation, { selectedIndex: bottomNavigationIndex, options: options, handleChange: function handleChange(index) {
