...
var Placeholder = function Placeholder(_ref) {
  ...
  return _react2.default.createElement(
    "div",
    {
      className: className + " upload-placeholder",
      style: hide ? { visibility: "hidden" } : {}
    },
    _react2.default.createElement(
      _components.FilePicker,
      {
        inputProps: (0, _extends3.default)({}, inputProps, { multiple: false }),
        handleimage: onFilePicked
      },
      _react2.default.createElement(
  ...
  function ImageUpload() {
    ...
    return (
      (_ret = ((_temp = ((_this = (0, _possibleConstructorReturn3.default)(
        this,
        (_ref2 =
          ImageUpload.__proto__ ||
          Object.getPrototypeOf(ImageUpload)).call.apply(
          _ref2,
          [this].concat(args)
        )
      )),
      ...
      (_this.onFilePicked = function(file, imageUri) {
        ...
        if (!isImage) {
          ...
          toggleSnackbarAndSetText(
            true,
            "The file " + file.name + " is more than 5mb",
            true
          );
        } else {
          if (images.length < 3) {
            fileUpload(formKey, fieldKey, {
              module: module,
              file: file,
              imageUri: imageUri
            });
  ...
  (0, _createClass3.default)(ImageUpload, [
    {
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          loading &&
            _react2.default.createElement(_components.LoadingIndicator, null),
          !images.length
            ? _react2.default.createElement(
                _components.FilePicker,
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  var images =
    (state.form[ownProps.formKey] &&
      state.form[ownProps.formKey].files &&
      state.form[ownProps.formKey].files[ownProps.fieldKey]) ||
    [];
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    toggleSnackbarAndSetText: function toggleSnackbarAndSetText(
      open,
      message,
      error
    ) {
      return dispatch(
        (0, _actions2.toggleSnackbarAndSetText)(open, message, error)
      );
    },
    fileUpload: function fileUpload(formKey, fieldKey, module, fileObject) {
      return dispatch(
        (0, _actions.fileUpload)(formKey, fieldKey, module, fileObject)
      );
    },
