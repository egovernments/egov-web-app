...
var translatedFormFields = function translatedFormFields(
  localizationLabels,
  form
) {
  ...
  fields = Object.keys(fields).reduce(function(translatedField, fieldKey) {
    var field = Object.keys(fields[fieldKey]).reduce(function(
      field,
      fieldName
    ) {
      ...
      if (
        fieldName === "hintText" ||
        fieldName === "floatingLabelText" ||
        fieldName === "errorMessage"
      ) {
        fieldValue = (0, _commons.getTranslatedLabel)(
          fieldValue,
          localizationLabels
        );
      }
    ...
    field["requiredMessage"] = (0, _commons.getTranslatedLabel)(
  ...
  if (form.submit && form.submit.label) {
    var label = (0, _commons.getTranslatedLabel)(
      form.submit.label,
      localizationLabels
    );
  ...
  return function(next) {
    return function(action) {
      ...
      if (type === _actionTypes2.ADD_LOCALIZATION) {
        ...
        var _localizationLabels = (0, _commons.transformLocalizationLabels)(
          action.localizationLabels
        );
        var forms = newState.form;

        Object.keys(forms).forEach(function(formKey) {
          var translatedForm = translatedFormFields(
            _localizationLabels,
            forms[formKey]
          );
          translatedForm = (0, _extends3.default)({}, translatedForm, {
            name: formKey
          });
