...
var failedTransactionFetchComplete = function failedTransactionFetchComplete(
  payload
) {
  return {
...
var successTransactionFetchError = function successTransactionFetchError(
  error
) {
  return {
...
var successTransactionFetchComplete = function successTransactionFetchComplete(
  payload
) {
  return {
...
var AssessmentStatusFetchComplete = function AssessmentStatusFetchComplete(
  payload
) {
  return {
...
var SingleAssessmentStatusFetchError = function SingleAssessmentStatusFetchError(
  error
) {
  return {
...
var SingleAssessmentStatusFetchComplete = function SingleAssessmentStatusFetchComplete(
  payload
) {
  return {
              ...
              switch ((_context.prev = _context.next)) {
                ...
                case 3:
                  ...
                  return (0, _api.httpRequest)(
                    _endPoints.BOUNDARY.GET.URL,
                    _endPoints.BOUNDARY.GET.ACTION,
                    queryObj[i]
                  );
...
var setMohallaInRedux = function setMohallaInRedux(
  dispatch,
  state,
  draftResponse
) {
  ...
  var mohallaCodes =
    drafts &&
    drafts.reduce(function(result, current) {
      if (current.draftRecord && current.draftRecord.prepareFormData) {
        if (!result[current.tenantId]) result[current.tenantId] = [];
        if (
          (0, _get2.default)(
            current,
            "draftRecord.prepareFormData.Properties[0].address.locality.code"
          ) &&
          result[current.tenantId].indexOf(
            (0, _get2.default)(
              current,
              "draftRecord.prepareFormData.Properties[0].address.locality.code"
            )
  ...
  return (function() {
    var _ref3 = (0, _asyncToGenerator3.default)(
      /*#__PURE__*/ _regenerator2.default.mark(function _callee2(
        ...
        var draftpayload,
          payloadProperty,
          payloadFailedPayments,
          payloadSuccessPayments;
        return _regenerator2.default.wrap(
            ...
            while (1) {
              switch ((_context2.prev = _context2.next)) {
                case 0:
                  ...
                  _context2.next = 5;
                  return (0, _api.httpRequest)(
                    _endPoints.DRAFT.GET.URL,
                    _endPoints.DRAFT.GET.ACTION,
                    queryObjectDraft
                  );
                ...
                case 13:
                  ...
                  _context2.next = 18;
                  return (0, _api.httpRequest)(
                    _endPoints.PROPERTY.GET.URL,
                    _endPoints.PROPERTY.GET.ACTION,
                    queryObjectproperty
                  );
                ...
                case 25:
                  ...
                  _context2.next = 30;
                  return (0, _api.httpRequest)(
                    _endPoints.PGService.GET.URL,
                    _endPoints.PGService.GET.ACTION,
                    queryObjectFailedPayments,
                    {},
                    [],
                    {},
                ...
                case 30:
                  ...
                  dispatch(
                    failedTransactionFetchComplete(payloadFailedPayments)
                  );
                  _context2.next = 37;
                  break;
                ...
                case 42:
                  ...
                  dispatch(
                    successTransactionFetchComplete(payloadSuccessPayments)
                  );
                  _context2.next = 49;
                  break;
...
var fetchReceipts = (exports.fetchReceipts = function fetchReceipts(queryObj) {
  return (function() {
    var _ref4 = (0, _asyncToGenerator3.default)(
      /*#__PURE__*/ _regenerator2.default.mark(function _callee3(dispatch) {
        var payloadReceipts;
        return _regenerator2.default.wrap(
            ...
            while (1) {
              switch ((_context3.prev = _context3.next)) {
                case 0:
                  ...
                  _context3.next = 4;
                  return (0, _api.httpRequest)(
                    _endPoints.RECEIPT.GET.URL,
                    _endPoints.RECEIPT.GET.ACTION,
                    queryObj,
                    {},
                    [],
                    { ts: 0 }
...
var getStatusAndAmount = function getStatusAndAmount(receiptArrayItem) {
  var receiptTransformed = receiptArrayItem.reduce(function(result, current) {
    ...
    result.totalAmountToPay =
      receiptArrayItem[receiptArrayItem.length - 1].totalAmount;
    return result;
  }, {});
...
var mergeReceiptsInProperty = function mergeReceiptsInProperty(
  receiptsArray,
  propertyObj
) {
  ...
  Object.keys(receiptsArray).forEach(function(item) {
    if (transformedPropertyObj.hasOwnProperty(item)) {
      transformedPropertyObj[item].receiptInfo = getStatusAndAmount(
        (0, _orderBy2.default)(receiptsArray[item], "totalAmount", "asc")
      );
    }
  });
  var mergedReceiptsProperties = Object.values(transformedPropertyObj).filter(
    function(property) {
  ...
  var groupByPropertyId = mergedReceiptsProperties.reduce(function(res, item) {
    ...
    if (!res[item.propertyId][item.financialYear])
      res[item.propertyId][item.financialYear] = [];
  ...
  for (var propertyId in groupByPropertyId) {
    for (var year in groupByPropertyId[propertyId]) {
      var assessmentByDate = (0, _orderBy2.default)(
        groupByPropertyId[propertyId][year],
        "assessmentDate",
        "asc"
      );
...
var getAssesmentsandStatus = (exports.getAssesmentsandStatus = function getAssesmentsandStatus(
  queryObjectproperty
) {
  return (function() {
    var _ref5 = (0, _asyncToGenerator3.default)(
      /*#__PURE__*/ _regenerator2.default.mark(function _callee4(dispatch) {
        var payloadProperty,
          propertybyId,
          consumerCodes,
          finalcc,
            ...
            while (1) {
              switch ((_context4.prev = _context4.next)) {
                ...
                case 4:
                  ...
                  propertybyId = (0, _commons.transformById)(
                    payloadProperty["Properties"],
                    "propertyId"
                  );
                  consumerCodes =
                    propertybyId &&
                    Object.values(propertybyId).reduce(function(result, curr) {
                      var propertyDetail =
                        curr &&
                        curr.propertyDetails &&
                        curr.propertyDetails.reduce(function(
                          consumerCodes,
                          item
                        ) {
                          consumerCodes[
                            curr.propertyId + ":" + item.assessmentNumber
                  ...
                  finalcc =
                    consumerCodes &&
                    consumerCodes.reduce(function(acc, curr) {
                ...
                case 11:
                  ...
                  receiptbyId = (0, _commons.transformById)(
                    payloadReceipts["Receipt"],
                    "transactionId"
                  );
                  receiptDetails =
                    receiptbyId &&
                    Object.values(receiptbyId).reduce(function(acc, curr) {
                      if (!acc[curr.Bill[0].billDetails[0].consumerCode])
                  ...
                  dispatch(
                    AssessmentStatusFetchComplete(
                      mergeReceiptsInProperty(receiptDetails, finalcc)
                    )
                  );
                  _context4.next = 20;
                  break;
...
var getSingleAssesmentandStatus = (exports.getSingleAssesmentandStatus = function getSingleAssesmentandStatus(
  queryObjectproperty
) {
  return (function() {
    var _ref6 = (0, _asyncToGenerator3.default)(
      /*#__PURE__*/ _regenerator2.default.mark(function _callee5(dispatch) {
        var latestPropertyDetails,
          consumerCodes,
          finalcc,
          payloadReceipts,
          payloadWithReceiptAsId,
          receiptbyId,
          receiptDetails;
        return _regenerator2.default.wrap(
              ...
              switch ((_context5.prev = _context5.next)) {
                case 0:
                  ...
                  latestPropertyDetails =
                    ...
                    (0, _PTCommon.getLatestPropertyDetails)(
                      queryObjectproperty.propertyDetails
                    );
                  consumerCodes =
                    queryObjectproperty &&
                    queryObjectproperty.propertyDetails &&
                    queryObjectproperty.propertyDetails.reduce(function(
                      acc,
                      item
                    ) {
                      acc[
                        queryObjectproperty.propertyId +
                          ":" +
                        ...
                        latestAssessmentNumber:
                          latestPropertyDetails.assessmentNumber
                      });
                      return acc;
                    },
                    {});
                ...
                case 7:
                  ...
                  payloadWithReceiptAsId = (0, _cloneDeep2.default)(
                    payloadReceipts["Receipt"]
                  )
                    ...
                    .map(function(item) {
                      item.receiptNumber = (0, _get2.default)(
                        item,
                  ...
                  dispatch(
                    SingleAssessmentStatusFetchComplete(
                      mergeReceiptsInProperty(receiptDetails, consumerCodes)
                    )
                  );
                  _context5.next = 17;
                  break;
                ...
                case 14:
                  ...
                  dispatch(
                    SingleAssessmentStatusFetchError(_context5.t0.message)
                  );
