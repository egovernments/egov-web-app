...
const getCitizenReceipetData = (tranformedData, ulbLogo) => {
          ...
          body: [
            [
              ...
              },
              {
                stack: [
                  {
                    text: tranformedData.corporationName,
...
const getReceiptData = (tranformedData, ulbLogo) => {
  let receiptData = {
    content: [
      {
        style: "tl-head",
...
export const generateReciept = async rowData => {
  ...
  const ulbLogo = get(
    state.screenConfiguration,
    "preparedFinalObject.base64UlbLogo",
    ""
  );
  let receipt_data = {};
  let transformedData = {};
