...
class AutoSuggestContact extends React.Component {
  state = {
    searchText: "",
  };
  ...
  onChangeText = (searchText, dataSource, params) => {
    ...
    const { onAutoCompletTextChangeCallBack } = this.props;
...
AutoSuggestContact.propTypes = {
  onNewRequest: PropTypes.func,
  onAutoCompletTextChangeCallBack: PropTypes.func,
...
export default AutoSuggestContact;
